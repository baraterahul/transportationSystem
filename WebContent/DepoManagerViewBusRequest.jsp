...
<body>
<div class="container">
  <h2>Depo_Manager View Bus Route Request</h2>
  <p></p>  
  ...
  <table class="table table-bordered table-striped">
    <thead>
      ...
      <th>Id</th>
        ...
        <th>Time</th>
        <th>View Request</th>
        <th>View Route Passenger Details</th>
         <th>Send Required Bus</th>
    ...
    <tbody id="myTable">
      <% 
								 ...
								 <tr>
									...
									<td><a href="ManagerViewRequest.jsp?id=<%=rset.getString(1)%>">View Request</a></td>
									<td><a href="ManagerViewRoutePassengerDetails.jsp?id=<%=rset.getString(1)%>">View Route Details</a></td>
									<td><a href="SendRequiredBusAtRoute.jsp?id=<%=rset.getString(1)%>">Send Bus</a></td>
									<%}%>
								  </tr>
    </tbody>
  </table>
