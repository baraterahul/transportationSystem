...
<body>
<div class="container">
  <h2>Depo_Manager Calculate Bus Profit</h2>
  <p></p>  
 ...
 <a href="DepoManagerHome.jsp" class="previous">&laquo; Back</a>
  ...
  <%
						...
						String qry = "select * from sendbusroute";
         ...
         <th>BusDetails</th>
          <th>Datee</th>
           <th>KM</th>
            <th>Ticket Price</th>
             <th>Request Count</th>
              <th>Calculate Profit</th>
         
     <!-- //   id, Rid, StartLocation, StartTime, EndLocation, EndType, RouteType, BusDetails, Datee, KM, Price, RCount -->
      </tr>
    </thead>
    ...
    <tbody id="myTable">
      <% 
								...
								<th><%=rset.getString(12)%></th>
									...
									<td><a href="CalculateBusProfit.jsp?id=<%=rset.getString(1)%>">Calculate</a></td>
									<%}%>
								  </tr>
    </tbody>
  </table>
